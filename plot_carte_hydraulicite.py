...
def create_geojson_from_hydraulicite(annee_mois:str, code_sandre:str):
    ...
    # TODO filtrer en fonction de l'ouverture de la station à cette date.
    ...
    output_geojson = Path(f"output/hydraulicite/hydraulicite-{code_sandre}-{annee_mois}.geojson")
...
if __name__ == "__main__":
    ...
    create_geojson_from_hydraulicite("2016-02", "BSH001")
